function getFrequencyContentOfSynchSpikes(spikes,useTrials,randFraction,F1freq,usestimcond,usel,trialDuration)
...
figure(); 
plot(linspace(0,trialDuration,size(S,1)),nanmean(S(:,f>=alphaBand(1) & f<=alphaBand(2)),2)./nanmean(S,2));
