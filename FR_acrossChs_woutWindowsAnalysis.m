function FR_acrossChs_woutWindowsAnalysis(expt,spikes,unitTag,fileInd,b,saveTag)
%
% INPUT
...
% Created: 11/3/11 - KR
disp('Making FR across channels fig - without windows analysis');

RigDef=RigDefs();
disp('Code assumes probe configuration is 1x16 in FR_acrossChs_woutWindowsAnalysis.');
