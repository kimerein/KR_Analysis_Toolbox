function [LFP,LFPPhoto_Fs,bandPassedLFP,photodiode,params]=alignLFPToPhotodiode(LFP,LFPPhoto_Fs,bandPassedLFP,photodiode,params)
...
% that trial. Colums of LFP are samples at different times relative to the
