function plotSpecgrams_forV1only_sepByCxSynch(datadir,outputDir,stimWindow,spontWindow1,spontWindow2,F1freq)
...
if iscell(datadir)
    ...
    for i=1:length(datadir)
        ...
        avSpecgram_low=avS(noTheta_trialAv_noLED,takePref,stimWindow,spontWindow1,spontWindow2,theta_trialAv_noLED,F1freq);
...
%         all_noTheta_trialAv_noLED.high.S=[all_noTheta_trialAv_noLED.high.S avSpecgram_high.S];
        ...
        avSpecgram_low=avS(noTheta_trialAv_LED,takePref,stimWindow,spontWindow1,spontWindow2,theta_trialAv_noLED,F1freq);
...
%         theta_trialAv_noLED=a.theta_trialAv_temp;
        ...
        avSpecgram_low=avS(theta_trialAv_noLED,takePref,stimWindow,spontWindow1,spontWindow2,theta_trialAv_noLED,F1freq);
...
%         all_theta_trialAv_noLED.high.S=[all_theta_trialAv_noLED.high.S avSpecgram_high.S];
        ...
        avSpecgram_low=avS(theta_trialAv_LED,takePref,stimWindow,spontWindow1,spontWindow2,theta_trialAv_noLED,F1freq);
...
%         all_theta_trialAv_LED.high.S=[all_theta_trialAv_LED.high.S avSpecgram_high.S];
        ...
        avSpecgram_low=avS(alltheta_trialAv_noLED,takePref,stimWindow,spontWindow1,spontWindow2,theta_trialAv_noLED,F1freq);
...
%         all_allTheta_trialAv_noLED.high.S=[all_allTheta_trialAv_noLED.high.S avSpecgram_high.S];
        ...
        avSpecgram_low=avS(alltheta_trialAv_LED,takePref,stimWindow,spontWindow1,spontWindow2,theta_trialAv_noLED,F1freq);
...
title('noTheta_trialAv_noLED ALL F1');
save([outputDir '\' 'noTheta_trialAv_noLED ALL F1.mat'],'sumS');
...
title('noTheta_trialAv_LED ALL F1');
save([outputDir '\' 'noTheta_trialAv_LED ALL F1.mat'],'sumS');
...
title('theta_trialAv_noLED ALL F1');
save([outputDir '\' 'theta_trialAv_noLED ALL F1.mat'],'sumS');
...
title('theta_trialAv_LED ALL F1');
save([outputDir '\' 'theta_trialAv_LED ALL F1.mat'],'sumS');
