function LFPsweepCorrelations_withSemblance(LFPbySweep,stimsForSweeps,timeVector)
...
%         figure;
%         title(['Comparing stim. cond. ' num2str(i) ' and ' num2str(j)]);
        s=semblance(timeVector,averages(i,:),averages(j,:),1200);
        [i j]
    end
end
