function doV1unitSpecgrams(outputDir,dLGNpsth,usel_noLED,usel_LED,uses,uses_tri)

% Mawake2
% uses=   {{1}; {2}; {3}; {4}; {5}; {6}; {7}; {8}};
% uses_tri={{[1:168]}; {[1:168]}; {[1:168]}; {[1:168]}; {[1:168]}; {[1:168]}; {[1:168]}; {[1:168]}};
% Mawake3
% uses=   {{1}; {2}; {3}; {4}; {5}; {6}; {7}; {8}};
% uses_tri={{[1:132]}; {[1:132]}; {[1:132]}; {[1:132]}; {[1:132]}; {[1:132]}; {[1:132]}; {[1:132]}};
% Mawake6
% uses=   {{1}; {2}; {3}; {4}; {5}; {6}; {7}; {8}};
% uses_tri={{[1:216 409:528]}; {[1:216 409:528]}; {[1:216 409:528]}; {[1:216 409:528]}; {[1:216 409:528]}; {[1:216 409:528]}; {[1:216 409:528]}; {[1:216 409:528]}};
% Mawake7
% uses=   {{1}; {2}; {3}; {4}; {5}; {6}; {7}; {8}};
% uses_tri={{[1:396]}; {[1:396]}; {[1:396]}; {[1:396]}; {[1:396]}; {[1:396]}; {[1:396]}; {[1:396]}};
% Mawake8
% uses=   {{1}; {2}};
% uses_tri={{[1:972]}; {[1:972]}};
% Mawake18
...
% Mawake27
% uses=   {{1}; {2}; {3}; {4}; {5}; {6}; {7}; {8}};
% uses_tri={{[1:348]}; {[1:348]}; {[1:348]}; {[1:348]}; {[1:348]}; {[1:348]}; {[1:348]}; {[1:348]}};
% Mawake35
% uses=   {{1}; {2}; {3}; {4}; {5}; {6}; {7}; {8}};
% uses_tri={{[1:96]}; {[1:96]}; {[1:96]}; {[1:96]}; {[1:96]}; {[1:96]}; {[1:96]}; {[1:96]}};
% Mawake44
% uses=   {{1}; {2}; {3}; {4}; {5}; {6}; {7}; {8}};
% uses_tri={{[1:244 805:1048]}; {[1:244 805:1048]}; {[1:244 805:1048]}; {[1:244 805:1048]}; {[1:244 805:1048]}; {[1:244 805:1048]}; {[1:244 805:1048]}; {[1:244 805:1048]}};
% Mawake96
