function alignMUA_UPstatesFor130923(expt,mua_xpoints,mua_ypoints,UPstates,useSpontUPs,fileInds,powerRatio)
...
if useSpontUPs==1
    for i=1:length(useLED)
        if ismember(useStimcond(i),1:9) & ismember(useLED(i),1)
            ups=UPstates{i};
