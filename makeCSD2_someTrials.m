function [dataInt,avLFPbySweep,LFPbySweep]=makeCSD2_someTrials(expt,fileInd,useTheseTrials)
% 17-20 fileInd

% useTheseTrials must be a logical vector the same length as the fileInd- and
% LEDcond-filtered spikes
