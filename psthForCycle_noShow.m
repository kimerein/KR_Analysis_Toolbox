function [varargout] = psthForCycle_noShow(spikes,binsize,hAxes,bsmooth,duration)
...
% n = n/numtrials; % Get spikes per bin per trial, don't normalize by binsize
