function [halfWidth,boolThin]=classifyWaveformWidth(spikes,thresh,spikeInd,Fs)

evChannel=spikes.info.detect.event_channel(spikeInd);
waveform=spikes.waveforms(spikeInd,:,evChannel);
